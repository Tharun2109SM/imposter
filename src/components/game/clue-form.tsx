...
export function ClueForm({ roomCode, playerId, word }: { roomCode: string; playerId: string; word: string }) {
  ...
  return (
    <form action={action} className="mx-auto max-w-xl rounded-3xl border border-[var(--border-cozy)] bg-white p-6 text-center shadow-[var(--shadow-soft)] sm:p-10">
      ...
      <h1 className="display-font text-4xl">Write your clue.</h1>
      ...
      <Button type="submit" disabled={clue.length < 2} className="mt-8 w-full disabled:cursor-not-allowed disabled:opacity-50">
